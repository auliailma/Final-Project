...
class TestLogin(unittest.TestCase):  # TEST SCENARIO
    ...
    def test_a_see_performance_trackers(self): 
        ...
        time.sleep(5)
        browser.find_element(By.XPATH,"/html/body/div/div[1]/div[1]/header/div[2]/nav/ul/li[1]/span/i").click() # klik menu drop-down Configure
        time.sleep(1)
        ...
        self.assertEqual(text_bawah, 'Performance Trackers')
