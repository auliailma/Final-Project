...
class TestLogin(unittest.TestCase):  # TEST SCENARIO
    ...
    def test_a_search_user(self): 
        ...
        time.sleep(5)
        browser.find_element(By.XPATH,"/html/body/div/div[1]/div[2]/div[2]/div/div[1]/div[2]/form/div[1]/div/div[1]/div/div[2]/input").send_keys("iinchou") #isi username
        time.sleep(1)
        ...
        self.assertIn('Admin', text_atas)
        self.assertEqual(text_bawah, 'System Users')
