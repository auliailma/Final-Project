...
class TestLogin(unittest.TestCase):  # TEST SCENARIO
    ...
    def test_a_access_buzz(self): 
        ...
        time.sleep(8)
        browser.find_element(By.XPATH,"/html/body/div/div[1]/div[1]/aside/nav/div[2]/ul/li[11]/a/span").click() # klik menu Buzz
        time.sleep(5)
